...
<template>
  <svg :width="width" :height="height" viewBox="0 0 634 633" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      ...
      <linearGradient x1="92.8996089%" y1="45.820525%" x2="8.64082518%" y2="54.8323242%" id="linearGradient-4">
      ...
      <linearGradient x1="61.1087051%" y1="3.63287421%" x2="43.7167019%" y2="43.072423%" id="linearGradient-12">
      ...
      <linearGradient x1="127.278646%" y1="49.7777778%" x2="2.08166817e-15%" y2="50.2222222%" id="linearGradient-14">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient x1="127.278646%" y1="47.5308642%" x2="2.08166817e-15%" y2="52.4691358%" id="linearGradient-15">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient x1="127.278646%" y1="46.1950059%" x2="2.08166817e-15%" y2="53.8049941%" id="linearGradient-16">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient x1="127.278646%" y1="35.3298611%" x2="2.08166817e-15%" y2="64.6701389%" id="linearGradient-17">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient x1="127.278646%" y1="4.875%" x2="2.08166817e-15%" y2="95.125%" id="linearGradient-18">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient x1="78.3339993%" y1="0%" x2="31.6676399%" y2="100%" id="linearGradient-19">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
