...
<template>
  <svg :width="width" :height="height" viewBox="0 0 634 633" version="1.1" xmlns="http://www.w3.org/2000/svg">
    <title>TanStack Logo</title>
    <defs>
      <linearGradient id="linearGradient-1" x1="50%" y1="0%" x2="50%" y2="71.6497581%">
        <stop stop-color="#6BDAFF" offset="0%"></stop>
        <stop stop-color="#F9FFB5" offset="31.9219843%"></stop>
        <stop stop-color="#FFA770" offset="70.626639%"></stop>
        <stop stop-color="#FF7373" offset="100%"></stop>
      </linearGradient>
      <circle id="path-2" cx="316.5" cy="316.5" r="316.5"></circle>
      <linearGradient id="linearGradient-4" x1="92.8996089%" y1="45.820525%" x2="8.64082518%" y2="54.8323242%">
        <stop stop-color="#EE2700" offset="0%"></stop>
        <stop stop-color="#FF008E" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-5" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#A17500" offset="0%"></stop>
        <stop stop-color="#5D2100" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-6" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#2F8A00" offset="0%"></stop>
        <stop stop-color="#90FF57" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-7" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#2F8A00" offset="0%"></stop>
        <stop stop-color="#90FF57" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-8" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#2F8A00" offset="0%"></stop>
        <stop stop-color="#90FF57" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-9" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#2F8A00" offset="0%"></stop>
        <stop stop-color="#90FF57" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-10" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#2F8A00" offset="0%"></stop>
        <stop stop-color="#90FF57" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-11" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#2F8A00" offset="0%"></stop>
        <stop stop-color="#90FF57" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-12" x1="61.1087051%" y1="3.63287421%" x2="43.7167019%" y2="43.072423%">
        <stop stop-color="#FFF400" offset="0%"></stop>
        <stop stop-color="#3C8700" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-13" x1="50%" y1="0%" x2="50%" y2="100%">
        <stop stop-color="#FFDF00" offset="0%"></stop>
        <stop stop-color="#FF9D00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-14" x1="127.278646%" y1="49.7777778%" x2="2.08166817e-15%" y2="50.2222222%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-15" x1="127.278646%" y1="47.5308642%" x2="2.08166817e-15%" y2="52.4691358%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-16" x1="127.278646%" y1="46.1950059%" x2="2.08166817e-15%" y2="53.8049941%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-17" x1="127.278646%" y1="35.3298611%" x2="2.08166817e-15%" y2="64.6701389%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-18" x1="127.278646%" y1="4.875%" x2="2.08166817e-15%" y2="95.125%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-19" x1="78.3339993%" y1="0%" x2="31.6676399%" y2="100%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-20" x1="57.9133333%" y1="0%" x2="44.88%" y2="100%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
      <linearGradient id="linearGradient-21" x1="50.4945833%" y1="0%" x2="49.68%" y2="100%">
        <stop stop-color="#FFA400" offset="0%"></stop>
        <stop stop-color="#FF5E00" offset="100%"></stop>
      </linearGradient>
    ...
    <g id="Icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Group-3-Copy" transform="translate(1, 0)">
        <mask id="mask-3" fill="white"><use xlink:href="#path-2"></use></mask>
        ...
        <g id="Group-2" mask="url(#mask-3)">
          <g
            transform="translate(358.1965, 370.0152) scale(-1, 1) rotate(-10) translate(-358.1965, -370.0152)translate(258.1965, 321.8281)"
          >
            <line
              id="Path-9"
              x1="17.5949044"
            ...
            <line
              ...
              stroke-linejoin="bevel"
            ></line>
            <g id="Group-6" stroke="none" stroke-width="1" fill-rule="evenodd" transform="translate(6.8389, -0)">
              <path
                id="Path-8"
        ...
        <g id="Group" mask="url(#mask-3)">
          <g
            transform="translate(211.2377, 279.787) rotate(3) translate(-211.2377, -279.787)translate(79.8271, 117.9649)"
          >
            <path
              id="Path-7"
        ...
        <mask id="mask-23" fill="white"><use xlink:href="#path-22"></use></mask>
        <circle stroke="#000000" stroke-width="25" cx="315.5" cy="316.5" r="304"></circle>
      </g>
    </g>
  </svg>
</template>
