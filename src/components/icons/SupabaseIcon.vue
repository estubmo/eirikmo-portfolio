...
<template>
  ...
  >
    <defs>
      <linearGradient
        :id="`${uniqueId}_supabase-linearGradient-1`"
        x1="20.8617445%"
        y1="20.6868812%"
        x2="63.4256086%"
        y2="44.0710077%"
      ...
      <linearGradient
        :id="`${uniqueId}_supabase-linearGradient-2`"
        x1="1.99116498%"
        y1="-13.1584008%"
        x2="21.4025077%"
        y2="34.708062%"
    ...
    <g>
      <path
        ...
        :fill="`url(#${uniqueId}_supabase-linearGradient-1)`"
      ></path>
      <path
        d="M149.601512,258.578826 C142.884085,267.038157 129.263882,262.403261 129.102024,251.601817 L126.735244,93.6176533 L232.963622,93.6176533 C252.204429,93.6176533 262.935398,115.840956 250.971119,130.909887 L149.601512,258.578826 Z"
        fill-opacity="0.2"
        :fill="`url(#${uniqueId}_supabase-linearGradient-2)`"
      ></path>
      <path
