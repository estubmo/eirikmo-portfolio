...
<template>
    <div class="grid grid-cols-3 gap-x-8 lg:gap-x-12 text-zinc-200 my-12">
        <div class="col-span-2 my-4">
            ...
            <p class="text-sm font-light italic text-zinc-300 break-words wrap">
        ...
        <div class="my-4 col-span-3 md:col-span-2 space-y-2">
            ...
            <p>
                Cheffelo is a leading supplier of meal kits in the Nordic region and a leader in Scandinavian food tech.
                The company is the parent organization of several well-established brands, including Godtlevert, Adams
                Matkasse, Linas Matkasse, and RetNemt. These brands are synonymous with quality, convenience, and
        ...
        <div class="flex flex-col col-span-3 md:col-span-2 gap-2">
            ...
            <p>
                During my tenure as a Front-End Web Developer at Cheffelo, I had the privilege of being a key
                contributor to the development of the RetNemt front end. My responsibilities extended beyond RetNemt as
                I later became an integral part of projects for all the brands under the Cheffelo umbrella.
            </p>
            <p>
                Within this role, I played a pivotal part in shaping the digital presence of these renowned brands. This
                encompassed the creation of web applications and user interfaces that not only met high industry
                standards but also contributed to enhancing the overall user experience. I was also responsible for the
                development of new features and the maintenance of existing ones. This included the implementation of
                new designs, the optimization of existing code, and the resolution of bugs and issues.
            </p>
        </div>
        <div class="flex flex-col col-span-3 md:col-span-2 gap-2">
            ...
            <ul class="pl-4 list-disc">
                <li>
                    Ported legacy front-end RetNemt to a modern stack. Built from scratch with Next.js, React, Redux
                    Toolkit, TypeScript and Tailwind CSS.
                </li>
                <li>Transitioned four front-ends from multiple repositories to a single Nx monorepo.</li>
                <li>
                    Developed over 20 reusable and responsive interface components in React with Typescript, such as a
                    food delivery calendar, various meal cards, and multiple components related to account settings and
                    navigation.
                </li>
        ...
        <div class="flex flex-col col-span-3 md:col-span-2 gap-2">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li><strong>GraphQL:</strong> Leveraging GraphQL for efficient data retrieval and manipulation.</li>
                    <li>
                        <strong>React:</strong> Utilizing React for building interactive and dynamic user interfaces.
                    </li>
                    <li>
                        <strong>Next.js:</strong> Employing Next.js to create performant and SEO-friendly web
                        applications.
                    </li>
                    <li>
                        <strong>Redux Toolkit:</strong> Utilizing Redux Toolkit for state management, ensuring data
                        consistency and efficient updates.
                    </li>
                    <li>
                        <strong>Nx Monorepo:</strong> Organizing the projects within a Nx Monorepo structure, which
                        simplifies code sharing and collaboration.
                    </li>
                </ul>
            </div>
        </div>
