...
<template>
  ...
  >
    <template #logo>
      <NuxtImg src="/images/work/adtube/logo.png" format="webp" alt="Adtube Logo" class="select-none w-full" />
    </template>
    <template #default>
      <div class="leading-7 text-white/90 w-full">
        ...
        <h2 class="font-light italic text-sky-200 break-words wrap">May 2020 - Apr 2021 · 1 yr</h2>
    ...
    <template #tech>
      ...
      <TechIcon v-slot="slotProps" href="https://www.mongodb.com//" name="MongoDB" :size="24">
        <MongoDbIcon :height="slotProps.height" :width="slotProps.width" />
      </TechIcon>
    </template>
  </ExperienceCard>
</template>
