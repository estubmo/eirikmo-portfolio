...
<template>
  <div class="grid grid-cols-3 gap-x-8 lg:gap-x-12 text-zinc-200 my-12">
    <div class="col-span-2 my-4">
      ...
      <h2 class="text-xl font-semibold text-[#d4c76c] break-words wrap">E-commerce
        Store & Gallery</h2>
      <h2 class="text-xl font-light text-sky-200 break-words wrap">Jan 2024</h2>
      <h3 class="text-xl font-light text-zinc-200 break-words wrap mt-2">Developer
        and System Administrator</h3>
    </div>
    ...
    <div class="my-4 col-span-3 md:col-span-2">
      ...
      <p>
        ...
        Norwegian artist Svanhild Stub. The website
        is built with Next.js, React, TypeScript, Framer-Motion and Tailwind CSS.
        The backend is powered by open source
        Shopify alternative, Medusa.js, Minio S3 file hosting, Meilisearch, Redis
        and PostgreSQL.
      </p>
      ...
      <p>
        ...
        wanted to use a modern stack, but I also
        wanted to use a headless e-commerce solution. I ended up using Medusa.js,
        which is a headless e-commerce
        solution built with Node.js and TypeScript. Medusa.js is a great
        alternative to Shopify, as it is open source
        and self-hosted. It also has a great community and is under active
        development.
      </p>
      <p>
        I used a starter repository for the Medusa.js storefront, powered by
        Next.js, which I modified to fit with my
        clients requirements. As an artist, Svanhild wanted a website that would
        showcase her art in a beautiful,
        animated yet minimalistic way. I worked closely with her to ensure that
        the website would meet her expectations.
        I put in a lot of effort to ensure that the website would be as performant
        and accessible as possible.
      </p>
      <p>
        The greatest challenge was hosting, as I did not want to use an expensive
        provider. I ended up using a VPS on
        Hetzner, where I installed Docker and Docker Compose. I then used Docker
        Compose to run the Medusa.js
        storefront, Minio S3 file hosting, Meilisearch, Redis and PostgreSQL. I
        also used Docker Compose to run a
        reverse proxy with Traefik, which I used to serve the website and handle
