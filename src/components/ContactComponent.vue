  ...
  <div class="flex flex-col p-4 max-w-xl gap-2">
    ...
    <div v-motion-slide-visible-once-left-custom class="flex">
      ...
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M14 14L34 34" stroke="#F9FAFB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M34 14V34H14" stroke="#F9FAFB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </svg>
    </div>
